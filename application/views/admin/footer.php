    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn btn btn-outline-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn btn-outline-primary"  href="<?=base_url('auth/logout');?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
