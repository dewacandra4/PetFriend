      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <!-- <div class="col-lg-5 d-none d-lg-block"> <img src="<?= base_url()?>assets/img/beauty_dog.png" alt="beauty_dog" height="650px"></div> -->
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form method="post" action="<?= base_url('auth/login')?>" class="user">
                    ...
                    <br>
                      <button type="submit" class="btn bg-gradient-danger btn-user btn-block text-white"> Login</button>
                    <br>
                  </form>
                  <div class="text-center">
              ...
              <div class="col-lg-5 d-none d-lg-block"> <img src="<?= base_url()?>assets/img/beauty_dog.png" alt="beauty_dog" height="585px"></div>
            </div>
          </div>
        </div>
      </div>
