...
<?= $this->session->flashdata('message');?>
    <div class="card shadow px-0 mb-5 mt-5" >
        <div class="card-header py-4">
            <h5 class="m-0 font-weight-bold text-dark text-center ml-4">Diagnosis Result History</h5>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="text-center">
                                ...
                                <!-- <form action="<?= base_url('doctor/history_diagnosis/detail')?>" method="post" id="dateForm">
                                ...
                                <a href="<?= base_url('doctor/history_diagnosis/detail/').$d['created_at'].'/'. $d['user_id']; ?>"><div class="btn btn-deep-orange text-light btn-sm glyphicon-object-align-horizontal"><i class="fas fa-search-plus"></i></div></a>
                                </div>
                            </div>
                            </td>               
                        </tr>
